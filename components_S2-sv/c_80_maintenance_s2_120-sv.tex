...
Om du är tveksam, kontakta Boschungs kundtjänst.
\stopPictPar
\stoptextbackground

 \ProductId får endast användas, underhållas och repareras av kvalificerad personal som utbildats av Boschungs kundtjänst.

De behörigheter som krävs för användning, underhåll och reparation tilldelas av Boschungs kundtjänst.
...
För mer information, kontakta Boschungs kundtjänsten.
\stopPictPar
\stoptextbackground
...
Smörj-\index{Smörjmedel+Bortskaffande} och drivmedel eller\index{Miljöskydd} föremål som förorenats med dessa medel (\eG\ filter, trasor) ska\index{Drivmedel+Bortskaffande} bortskaffas i enlighet med gällande miljöregler.
\stopPictPar
\stoptextbackground
...
Observera: Vid en volymandel på mer än 60\hairspace\percent\
frostskyddsmedel {\em sjunker} frostskyddet och kyleffekten försämras!}
...
\PMrtfm
\PictPar
Om ett fel inte går att radera ska du kontakta Boschungs kundtjänst.
\stopPictPar
\stoptextbackground
