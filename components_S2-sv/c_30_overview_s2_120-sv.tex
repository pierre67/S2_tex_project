...
Den slimmade designen gör \sdeux\ till en riktig\quotation{allround}maskin för gator och trottoarer i tätorter. Den kraftfulla dieselmotorn i kombination med den kompakta hydrostatiska framdrivningen (hydrauliska radialkolvmotorer på framhjulen) säkerställer högsta mobilitet i alla situationer, oberoende på hur arbetsplatsen ser ut eller fyllnadsnivån i smutsbehållaren.
...
\placefig[margin][overview:cab:frontright]{\sdeux\ i driftklar skick}
{\externalfigure[overview:cab:twoleft][width=\Bildwidth]}

Deninglasade förarhytten har två bekväma sittplatser som är utrustade med trepunktsbälten. \sdeux\ kan som tillval även utrustas med klimatanläggning.
...
Förarhytten\index{Förarhytt} är utrustad \sdeux\ med högerstyrning och utformad för två personer. Den är ljudisolerad och har monterats på vibrationsdämpande silentblock.
...
\startfigtext[right][overview:joy:sideview]{Manöverpanel}
...
En kontakt\index{Uppsugning} på multifunktionskonsolen slår på kvastar och vattenpump samtidigt.\footnote{För mer information om vattenpumpen, se\in[chap:using] \about[chap:using], särskilt\about[sec:using:work], \atpage[sec:using:work].}
...
\sym{Återvinningsvatten} Om nivån i tanken för återvinningsvatten ligger värmeväxlaren (se ovan), visas symbolen~\textSymb{vpad_rwater_orange} (gul) på Vpad-bildskärmen. Om nivån är för låg visas symbolen ~\textSymb{vpad_rwater} (röd).
\stopitemize
...
\NC Allmänt \NC Taktung \NC Fyrtakts \NC\NR
...
\NC\NC Oljeförbrukning \unite{Liter/20\,h} \NC <\:0,1 \NC\NR
