...
\SymVpad
\textDescrHead{Service display}(yellow) Regular vehicle maintenance is due. Consult the maintenance schedule.

+\:Error message \# 650 to \# 653, or \# 703
\stopSymVpad
...
\subsubsubject{More displays on the Vpad}
