...
\SymVpad
\textDescrHead{Acudir al taller}(amarillo) Mantenimiento regular del vehículo (véase \about [sec:schedule] \atpage [sec:schedule])
o se ha registrado un error en el motor (necesario un taller técnico especializado).
...
{\md Aviso:} {\lt ¡{\em No} apague el motor mientras sea posible y esté encendida esta indicación!}
\stopSymVpad
