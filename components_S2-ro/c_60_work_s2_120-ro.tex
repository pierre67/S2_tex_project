...
{\externalfigure [work:select:fDrive]}{Maneta selectorul de viteză în poziția {\em Mers înainte}}
{\externalfigure [work:select:rDrive]}{Maneta selectorul de viteză în poziția {\em Mers înapoi}}
\stopcombination}
\stop


\startSteps [continue]
\item Rotiți comutatorul manetei selectorului de viteze, pentru a trece în altă treaptă de viteză în modul de {\em Transport}:
\startitemize [R]
\item Prima treaptă
\item A doua treaptă (mod de funcționare automat; pornește automat în prima treaptă)
\stopitemize

sau apăsați pe butonul exterior al manetei, pentru a activa/dezactiva modul de {\em Lucru}.
\stopSteps
...
\PMrtfm
\PictPar
În modul de {\em Lucru}, este disponibilă doar prima treaptă de viteză, iar motorul are o turație de 1300\,min\high{\textminus 1}.
...
\startSteps
\item Activați frâna de mână (maneta dintre scaune) și poziționați maneta schimbătorului de viteză în poziția {\em Neutră}.
...
\item Activați\index{Aspirare} modul de {\em Lucru} (butonul din exteriorul manetei schimbătorului de viteze).
\stopSteps
...
\item Cu ajutorul joystick-urilor corespunzătoare, aduceți măturile într-o poziție adecvată, astfel încât acestea să poată atinge raza optimă de lucru.
\stopSteps
...
\startSteps [continue]
\item Atunci când există riscul ca deșeuri de dimensiuni mai mari (\eG\ sticle PET) să blocheze gura de aspirare, deschideți\index{Clapetă gunoi grosier} clapeta pentru gunoi grosier folosind tastele laterale de pe consola multifuncțională sau~– dacă nu este suficient~– ridicați\index{Gură de aspirare+Gunoi grosier} temporar gura de aspirare.
\stopSteps
...
\item Activați frâna de mână și poziționați maneta schimbătorului de viteză în poziția {\em Neutră}. (Necesar pentru decuplarea întrerupătorului pentru înclinarea recipientului)
\stopSteps
...
\item Atunci când recipientul a fost golit complet, curățați interiorul cu un jet de apă. În acest scop, puteți utiliza pistolul integrat de apă (dotare opțională).
\stopSteps
...
Recipientul de gunoi este complet coborât; \sdeux\ se află în modul de {\em Lucru}.
(A se vedea \in{§}[sec:using:start], \atpage[sec:using:start].)

\startfigtext[left][fig:using:suction:hose]{Furtun de aspirare manuală}
{\externalfigure[work:suction:hose]}
\startSteps
\item Apăsați tasta~\textSymb{temoin_aspiration_manuelle} a consolei de tavan, pentru a activa sistemul de aspirare.
...
În rezervorul pentru apă proaspătă se află o cantitate suficientă de apă; \sdeux se află în modul de {\em Lucru}.
(A se vedea \in{§}[sec:using:start], \atpage[sec:using:start].)
...
\startSteps
\item Apăsați tasta~\textSymb{temoin_buse} a consolei de tavan, pentru a activa pompa de apă de înaltă presiune.
\item Trageți frâna de mână, înainte de a părăsi cabina șoferului.
...
\item Activați\index{A 3-a mătură} modul de {\em Lucru} (butonul din exteriorul manetei schimbătorului de viteze).
\stopSteps
...
\item Apăsaţi tasta~\textSymb{joy_key_frontbrush_left} sau~\textSymb{joy_key_frontbrush_right},
pentru a roti mătura în direcţia dorită.

\item Verificați turația motorului cu ajutorul
tastelor~\textSymb{joy_key_frontbrush_increase} și~\textSymb{joy_key_frontbrush_decrease}
a consolei multifuncțioanle.
