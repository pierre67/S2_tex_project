...
\textDescrHead{Sans 3\high{e} balai (ou inactif):}
...
Pour ajuster la position des balais latéraux lorsque le véhicule est équipé d’un 3\high{e} balai (option),
il faut désactiver le 3\high{e} balai (presser la touche \textSymb{joy_key_frontbrush_act}).
}\par


\textDescrHead{Avec 3\high{e} balai activé:}
Le joystick gauche permet de lever et baisser le 3\high{e} balai (\textSymb{joystick_aa})
...
\SymVpad
\textDescrHead{Arrêt} Désactiver le service actif.\index{troisième balai}
...
\SymVpad
\textDescrHead{Tempomat} Activer le tempomat\note[drive:tempomat] et enregistrer la vitesse actuelle.\index{console de commande}
...
\SymVpad
\textDescrHead{Rotation des balais} Diminuer la vitesse de rotation des balais latéraux ou du 3\high{e} balai (si équipé).\index{balayage}
\stopSymVpad

\startSymVpad
\externalfigure[joy:ftbrs:plus]
\SymVpad
\textDescrHead{Rotation des balais} Augmenter la vitesse de rotation des balais latéraux ou du 3\high{e} balai
(si équipé).
\stopSymVpad
...
\SymVpad
\textDescrHead{3\high{e} balai actif} Pressez cette touche pour activer|/|désactiver le 3\high{e} balai.
\stopSymVpad

\startSymVpad
\externalfigure[joy:ftbrs:right]
\SymVpad
\textDescrHead{3\high{e} balai à gauche} Pressez cette touche pour travailler avec le 3\high{e} balai placé sur le côté gauche
...
\SymVpad
\textDescrHead{3\high{e} balai à droite} Pressez cette touche pour travailler avec le 3\high{e} balai placé sur le côté droit
